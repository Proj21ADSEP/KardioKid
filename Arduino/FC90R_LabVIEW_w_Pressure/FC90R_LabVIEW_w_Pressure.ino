...
void loop()
{
  ...
  if (serialCommand == 48){
    ...
    Serial.println(String("Moving Up...      "));
    delay(5);
    }
    ...
    moveDown();
    //Serial.println(serialCommand);
    Serial.println(String("Moving Down...    "));
    delay(5);
    }
    ...
    ++stopValue;
    //Serial.println(serialCommand);
    Serial.println(String("Center Value is ") + stopValue);
    delay(10);
    }
    ...
    //Serial.println(serialCommand);
    Serial.println(String("Step Value is ") + stepValue);
    delay(10);
    }
    ...
    Serial.println("Centering Zero Position");
    delay(10);
    checkOnStartup();
   }
...
delay(25); //restricts to about 40 Hz for now...
